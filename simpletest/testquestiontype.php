...
/**
 * Unit tests for the ccode question type class.
 *
 * @package    qtype
 * @subpackage ccode
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ccode_test extends UnitTestCase {
    protected $qtype;

    public function setUp() {
        $this->qtype = new qtype_ccode();
    }
    ...
    public function test_name() {
        $this->assertEqual($this->qtype->name(), 'ccode');
    }
